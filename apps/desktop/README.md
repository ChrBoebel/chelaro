...
- Bestehende `0.2.x`-Apps benötigen einmalig die manuelle `0.3.1`-Installation aus der GitHub-DMG.
- Ab `0.3.1` prüft Chelaro den neuesten stabilen GitHub Release beim Start und alle sechs Stunden.
